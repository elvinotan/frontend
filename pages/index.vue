      ...
      <EForm id="Decimal">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>allowMinus</td>
              <td><input v-model="decimal.allowMinus" type="checkbox" /></td>
              <td>Boolean</td>
              <td>false</td>
              <td>false</td>
              <td>Boleah tidaknya menggunakan sign minus(-)</td>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>string</td>
              <td>
                Tipe data converter, bila tidak di provide maka tipe data sesuai
                option, bila di sediakan makan nilai value akan di convert
              </td>
            </tr>
            <tr>
              <td>vruntime</td>
            ...
            <tr>
              ...
              <td>''</td>
              <td>
                Data Option pilihan dengan format { value: null, description:
                null }
              </td>
            </tr>
          </tbody>

        ...
        <ETabs id="Component" :labels="tabs" selected-tab="EText">
          ...
          <EForm id="EPassword">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td><input v-model="password.label" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Label untuk component, bila tidak di bind maka sign * tidak di tampilkan</td>
                ...
                <tr>
                  <td>placeholder</td>
                  <td><input v-model="password.placeholder" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Place holder input, akan tampil bila data kosong</td>
                ...
                <tr>
                  <td>maxlength</td>
                  <td>
                    <input v-model.number="password.maxlength" type="number" />
                  </td>
                  <td>Number</td>
                  <td>false</td>
                  <td>16</td>
                ...
                <tr>
                  <td>required</td>
                  <td><input v-model="password.required" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan required atau tidak text, error message akan otomatis terisi bila kosong</td>
                ...
                <tr>
                  <td>disabled</td>
                  <td><input v-model="password.disabled" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan disabled atau tidaknya component</td>
                ...
                <tr>
                  <td>show</td>
                  <td><input v-model="password.show" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
                  <td>Boolean untuk menentukan component tampil atau tidak. tag ini menggunakan v-if</td>
                ...
                <tr>
                  <td>value</td>
                  <td><input v-model="password.value" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Two way data binding, saat ini data yang di input dalam bentuk upprcase, customize sesuai kebutuhan</td>
          ...
          <EForm id="EDecimal">
            <EDecimal
              ...
              :show="decimal.show"
              :vruntime="decimal.vruntime"
              :allow-minus="decimal.allowMinus"
            ...
            <br />
            <div class="text-xs">Data Object : {{ decimal }}</div>
            <br />
            <table>
              <thead>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td><input v-model="decimal.label" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Label untuk component</td>
                ...
                <tr>
                  <td>placeholder</td>
                  <td><input v-model="decimal.placeholder" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Place holder input, akan tampil bila data kosong</td>
                ...
                <tr>
                  <td>maxlength</td>
                  <td>
                    <input v-model.number="decimal.maxlength" type="number" />
                  </td>
                  <td>Number</td>
                  <td>false</td>
                  <td>18</td>
                ...
                <tr>
                  <td>disabled</td>
                  <td><input v-model="decimal.disabled" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan disabled atau tidaknya component,</td>
                ...
                <tr>
                  <td>required</td>
                  <td><input v-model="decimal.required" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan required atau tidak text, error message akan otomatis terisi bila kosong</td>
                ...
                <tr>
                  <td>show</td>
                  <td><input v-model="decimal.show" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
                  <td>Boolean untuk menentukan component tampil atau tidak. tag ini menggunakan v-if</td>
                ...
                <tr>
                  <td>value</td>
                  <td><input v-model.number="decimal.value" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Two way data binding, saat ini data yang di input dalam bentuk upprcase, customize sesuai kebutuhan</td>
                ...
                <tr>
                  <td>allowMinus</td>
                  <td>
                    <input v-model="decimal.allowMinus" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                ...
                <tr>
                  <td>separator</td>
                  <td><input v-model="decimal.separator" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Number formated dengan separator default menggunakan config US, koma untuk ribuan dan . untuk fraksi</td>
                ...
                <tr>
                  <td>minimum</td>
                  <td>
                    <input v-model.number="decimal.minimum" type="number" />
                  </td>
                  <td>Number</td>
                  <td>false</td>
                  <td>null</td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('DecimalComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
          ...
          <EForm id="ETime">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td><input v-model="time.label" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Label untuk component</td>
                ...
                <tr>
                  <td>disabled</td>
                  <td><input v-model="time.disabled" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan disabled atau tidaknya component,</td>
                ...
                <tr>
                  <td>required</td>
                  <td><input v-model="time.required" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan required atau tidak text, error message akan otomatis terisi bila kosong</td>
                ...
                <tr>
                  <td>show</td>
                  <td><input v-model="time.show" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
                  <td>Boolean untuk menentukan component tampil atau tidak. tag ini menggunakan v-if</td>
                ...
                <tr>
                  <td>value</td>
                  <td><input v-model="time.value" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Two way data binding, saat ini data yang di input dalam bentuk upprcase, customize sesuai kebutuhan</td>
                ...
                <tr>
                  <td>minimum</td>
                  <td><input v-model="time.minimum" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>null</td>
                ...
                <tr>
                  <td>maximum</td>
                  <td><input v-model="time.maximum" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>null</td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('TimeComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
                <tr>
                  <td>clearError</td>
                  <td>
                    <button @click="clearError('TimeComponent')">Click</button>
                  </td>
                  <td>Void</td>
                  <td>Hapus error, kembalikan ke state component semula</td>
                </tr>
                ...
                <tr>
                  <td>validate</td>
                  <td>
                    <button @click="validate('TimeComponent')">Click</button>
                  </td>
                  <td>{{ valid }}</td>
                  <td>Lakukan validasi berdasarkan required dan vruntime</td>
                </tr>
          ...
          <EForm id="ESelect">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td><input v-model="select.label" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Label untuk component</td>
                ...
                <tr>
                  <td>placeholder</td>
                  <td><input v-model="select.placeholder" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Place holder input, akan tampil bila data kosong</td>
                ...
                <tr>
                  <td>required</td>
                  <td><input v-model="select.required" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan required atau tidak text, error message akan otomatis terisi bila kosong</td>
                ...
                <tr>
                  <td>disabled</td>
                  <td><input v-model="select.disabled" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                  <td>Boolean untuk menentukan disabled atau tidaknya component,</td>
                ...
                <tr>
                  <td>show</td>
                  <td><input v-model="select.show" type="checkbox" /></td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
                  <td>Boolean untuk menentukan component tampil atau tidak. tag ini menggunakan v-if</td>
                ...
                <tr>
                  <td>value</td>
                  <td><input v-model="select.value" type="input" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>''</td>
                  <td>Two way data binding, saat ini data yang di input dalam bentuk upprcase, customize sesuai kebutuhan</td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('SelectComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
                ...
                <tr>
                  <td>validate</td>
                  <td>
                    <button @click="validate('SelectComponent')">Click</button>
                  </td>
                  <td>{{ valid }}</td>
                  <td>Lakukan validasi berdasarkan required dan vruntime</td>
                </tr>
          ...
          <EForm id="EMultiUpload">
            ...
            <br />
            <div class="text-xs">Data Object : {{ multiUpload }}</div>
            <table>
              <thead>
                <tr>
                  <td>Props</td>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td><input v-model="multiUpload.label" type="text" /></td>
                  <td>String</td>
                  <td>false</td>
                  <td>Please Provide Table title...</td>
                  <td>Label untuk component</td>
                ...
                <tr>
                  <td>show</td>
                  <td>
                    <input v-model="multiUpload.show" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
                ...
                <tr>
                  <td>disabled</td>
                  <td>
                    <input v-model="multiUpload.disabled" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                ...
                <tr>
                  <td>required</td>
                  <td>
                    <input v-model="multiUpload.required" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>false</td>
                ...
                <tr>
                  <td>maxFile</td>
                  <td>
                    <input v-model="multiUpload.maxFile" type="number" />
                  </td>
                  <td>Number</td>
                  <td>false</td>
                  <td>50</td>
                  <td>Jumlah Maxium File yang bisa di upload</td>
                </tr>
                <tr>
                  <td>maxSize</td>
                  <td>
                ...
                <tr>
                  <td>accept</td>
                  <td>
                    <input v-model="multiUpload.accept" type="text" />
                  </td>
                  <td>String</td>
                  <td>false</td>
                  <td>image/jpeg image/jpg image/jpg application/pdf text/plain video/mp4</td>
                ...
                <tr>
                  <td>files</td>
                  <td>
                    <input v-model="multiUpload.files" type="number" />
                  </td>
                  <td>Array</td>
                  <td>false</td>
                  <td>[]</td>
                  <td>Bind proprties untuk files</td>
                </tr>
                <tr>
                  <td>onLoad</td>
                  <td>-</td>
                  ...
                  <td>false</td>
                  <td>null</td>
                  <td>Function Binding yang mewajibkan untuk return id dari GnFile</td>
                </tr>
                <tr>
                  <td>onAdd</td>
                  <td>-</td>
                  ...
                  <td>false</td>
                  <td>null</td>
                  <td>Function Binding yang mewajibkan untuk return Object sesuai dengan stucture model</td>
                </tr>
              </tbody>
            </table>
            <br />
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('MultiUploadComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
                <tr>
                  <td>clearError</td>
                  <td>
                    <button @click="clearError('MultiUploadComponent')">Click</button>
                  </td>
                  <td>Void</td>
                  <td>Hapus error, kembalikan ke state component semula</td>
                </tr>
                <tr>
                  <td>hasError</td>
                  <td>
                    <button @click="hasError('MultiUploadComponent')">Click</button>
                  </td>
                  <td>{{ haserror }}</td>
                  <td>Flag untuk menandakan apakah component pass validasi atau tidak</td>
                </tr>
                <tr>
                  <td>addError</td>
                  <td>
                    <button @click="addError('MultiUploadComponent')">Click</button>
                  </td>
                  <td>-</td>
                  <td>Penambahan error secara manual, programtically</td>
                </tr>
                <tr>
                  <td>validate</td>
                  <td>
                    <button @click="validate('MultiUploadComponent')">Click</button>
                  </td>
                  <td>{{ valid }}</td>
                  <td>Lakukan validasi berdasarkan required dan vruntime</td>
                </tr>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>show</td>
                  <td>
                    <input v-model="localPagination.show" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>label</td>
                  <td>
                    <input v-model="serverPagination.label" type="text" />
                  </td>
                  <td>String</td>
                  <td>false</td>
                  <td>Please Provide Table title...</td>
                ...
                <tr>
                  <td>show</td>
                  <td>
                    <input v-model="serverPagination.show" type="checkbox" />
                  </td>
                  <td>Boolean</td>
                  <td>false</td>
                  <td>true</td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('FormComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
                <tr>
                  <td>setShow</td>
                  <td>
                    <button @click="setShow('FormComponent')">Click</button>
                  </td>
                  <td>-</td>
                  <td>Method untuk set show container atau hide</td>
                </tr>
              </tbody>
            </table>
          </EForm>
          ...
          <EForm id="ECol">
            <ECol id="ColComponent" ref="ColComponent" :col="col.col" :gap-x="col.gapX" :gap-y="col.gapY">
              ...
              <div style="background: yellow">GROUP 4</div>
              <div style="background: yellow">GROUP 5</div>
              <div style="background: yellow">GROUP 6</div>
              <div style="background: yellow">GROUP 7</div>
              <div style="background: yellow">GROUP 8</div>
            </ECol>
            <br />
            <div class="text-xs">Template : {{ htmlCol }}</div>
            <br />
            <div class="text-xs">Data Object : {{ col }}</div>
            <table>
              <thead>
                <tr>
                  <td>Props</td>
              ...
              <tbody>
                <tr>
                  <td>col</td>
                  <td><input v-model.number="col.col" type="number" /></td>
                  <td>Number</td>
                  <td>false</td>
                  <td>1</td>
                  <td>Jumlah colum yang di inginakan dalam 1 baris</td>
                </tr>
                <tr>
                  <td>gapX</td>
                  <td><input v-model.number="col.gapX" type="number" /></td>
                  <td>Number</td>
                  <td>false</td>
                  <td>3</td>
                ...
                <tr>
                  <td>gapY</td>
                  <td><input v-model.number="col.gapY" type="number" /></td>
                  <td>Number</td>
                  <td>false</td>
                  <td>2</td>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>metaData</td>
                  <td>
                    <button @click="metaData('ColComponent')">Click</button>
                  </td>
                  <td>{{ metadata }}</td>
                  <td>Component Information</td>
                </tr>
        ...
        <ETabs id="Plugin" :labels="[{ label: 'fmt' }, { label: 'enum' }, { label: 'string' }, { label: 'number' }, { label: 'array' }, { label: 'wrapper' }, { label: 'rest' }]" selected-tab="fmt">
          ...
          <EForm id="fmt">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>date: (value = null, pattern = 'DD/MM/YYYY') => {}</td>
                  <td>String</td>
                  <td>
                    value: Date <br />
                    pattern: String <br />
                    DD=Date (XX), MM=Month (XX), YYYY=Year (YYYY)
                  </td>
                </tr>
                <tr>
                  <td>number: (value = null) => {}</td>
                  <td>String</td>
                  <td>
                    value: Number <br />
                    Akan memformat angka menjadi comma delimeter tanpa fraction
                    <br />
                    Ex: 123456 => 123,456
                  </td>
                </tr>
...
export default {
  data() {
    return {
      ...
      htmlButton: '<EButton id="" ref="" :label="" :disabled="" :color="" :show="" @click="" />',
